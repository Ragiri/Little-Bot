let Client,GuildMember,prefix,token;_56c‍.w("discord.js",[["Client",["Client"],function(v){Client=v}],["GuildMember",["GuildMember"],function(v){GuildMember=v}]]);_56c‍.w("./config.json",[["prefix",["prefix"],function(v){prefix=v}],["token",["token"],function(v){token=v}]]);
...
bot.on('ready', () => {
    ...
    _56c‍.g.console.log(bot.channels);
...
function play(guild, song) {
    ...
    const dispatcher = serverQueue.connection
      ...
      .on("error", error => _56c‍.g.console.error(error));
        ...
        async function execute() {
          ...
          if (args[1].indexOf("http") == 0) {
            ...
            search(truc, opts, async function(err, results) {
                if(err)
                    return _56c‍.g.console.log(err);
              video = await results[1].link;
              _56c‍.g.console.log(results[1].link);
