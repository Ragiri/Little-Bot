let Client,GuildMember,prefix,token;_fb7‍.w("discord.js",[["Client",["Client"],function(v){Client=v}],["GuildMember",["GuildMember"],function(v){GuildMember=v}]]);_fb7‍.w("./config.json",[["prefix",["prefix"],function(v){prefix=v}],["token",["token"],function(v){token=v}]]);
...
bot.on('ready', () => {
    ...
    _fb7‍.g.console.log(bot.channels);
...
function play(guild, song) {
    ...
    const dispatcher = serverQueue.connection
      ...
      .on("error", error => _fb7‍.g.console.error(error));
        ...
        async function execute() {
          ...
          if (args[1].indexOf("http") == 0) {
            ...
            search(truc, opts, async function(err, results) {
                if(err)
                    return _fb7‍.g.console.log(err);
              video = await results[1].link;
              _fb7‍.g.console.log(results[1].link);
